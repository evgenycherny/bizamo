...
@RequiredBeforeHandler(Handler2Double.class)
public class HandlerRequires2RequiredBefore2Double extends AbstractHandlerDouble {
	private String id;
	public HandlerRequires2RequiredBefore2Double(String id) {
		this.id = id;
	}
	@Override
